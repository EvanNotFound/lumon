...
@pytest.mark.asyncio
async def test_tick_suppresses_raw_heartbeat_control_output(tmp_path, monkeypatch) -> None:
    """Control tokens like HEARTBEAT_OK should never be notified."""
    (tmp_path / "HEARTBEAT.md").write_text("- [ ] check status", encoding="utf-8")
