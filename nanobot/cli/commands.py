...
def agent(
    ...
    async def _cli_progress(content: str, *, tool_hint: bool = False) -> None:
        ...
        progress_kind = "tool_hint" if tool_hint else "reasoning"
        if not should_emit_progress(ch, tool_hint=tool_hint, progress_kind=progress_kind):
            return
                ...
                while True:
                    try:
                        ...
                        if msg.metadata.get("_progress"):
                            if should_emit_progress_message(
                                msg.metadata, agent_loop.channels_config
                            ):
